...
const projects: Project[] = [
  ...
  {
    id: 3,
    title: 'SmartAuth: Face & Gesture Recognition',
    description: 'Authentication system using facial recognition and hand gestures to control IoT-based smart home systems.',
    image: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=800',
    technologies: ['Python', 'OpenCV', 'MediaPipe', 'MQTT', 'Raspberry Pi', 'face_recognition'],
