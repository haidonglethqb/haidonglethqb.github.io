...
export const GraduationCapIcon: React.FC<IconProps> = ({ size = 24, color = 'currentColor', className }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const ReactIcon: React.FC<IconProps> = ({ size = 24, color = 'currentColor', className }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={color} className={className}>
    <circle cx="12" cy="12" r="2.5"/>
    <path fill="none" stroke={color} strokeWidth="1" d="M12 21.5c-3.04 0-5.952-.714-8.5-1.983M12 21.5c3.04 0 5.952-.714 8.5-1.983M12 2.5c3.04 0 5.952.714 8.5 1.983M12 2.5c-3.04 0-5.952.714-8.5 1.983"/>
